...
export default class RicePurityTest extends Component {
  constructor() {
    super()
  ...
  handleCheckboxChange({ target }) {
    ...
    const newPurity = this.normalize(0, 100,
      purity + (target.checked ? -1 : 1))
  ...
  clearCheckboxes(e) {
    ...
    document.querySelectorAll('.rpt__checkbox')
      .forEach((checkbox) => {
